...
final class File extends Storage
{
    ...
    private const EXTENSIONS=['pdf','zip','txt','csv','doc','docx','xls','xlsx'];
    public static function isAllowed(): array{return self::MIMES;}
    public function upload(array $file,string $name): string{return $this->store($file,$name,self::MIMES,self::EXTENSIONS);}
}
